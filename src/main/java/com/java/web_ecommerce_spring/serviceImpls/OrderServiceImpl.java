...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public List<Order> orderLast() {
        return orderRepository.orderLast();
    }
    ...
    @Override
    public List<Order> findOrderByUser(User user, Sort sort){
        return  orderRepository.findOrderByUser(user,sort);
    }
