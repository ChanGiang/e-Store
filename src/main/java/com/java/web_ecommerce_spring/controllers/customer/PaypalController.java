...
public class PaypalController {
    ...
    public ModelAndView momo(@PathVariable int orderId) {
        ModelAndView mv = new ModelAndView("public/momo");
        Order order = orderService.findOrderById(orderId);
        mv.addObject("order",order);
        return mv;
    }

    @PostMapping("/checkmomo/{orderId}")
    public ModelAndView checkmomo(@PathVariable int orderId) {
    ...
    @PostMapping("/paymomo/{orderId}")
    public ModelAndView paymomo(@PathVariable int orderId) {
        ModelAndView mv = new ModelAndView("redirect:/admin/order");
        Order order = orderService.findOrderById(orderId);
