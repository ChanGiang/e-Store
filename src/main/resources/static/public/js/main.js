...
/*    $("#form-signin").validate({
    ...
    let carts1 = document.querySelector('.muangay');
    if (carts1) {
        carts1.addEventListener('click', () => {
            var productId = document.getElementById("productId").value;
            var quantity = document.getElementById("quantity").value;
            $.ajax({
                url: "/public/cart/add/buyNow",
                type:"post",
                data:{
                    productId:productId,
                    quantity:quantity
                ...
                success: function(data){
                    ...
                    if(data == 0){
                        ...
                        div.innerHTML = data;
                        window.location.href = "http://localhost:8085/public/cart/index";
                    }
